...
- Use Node.js 24.11+ LTS or 26+ as the runtime, Vitest for tests, and tsdown for library builds; run scripts through pnpm.
...
- Keep package exports, tsdown runtime/declaration entries, and smoke imports in lockstep.
