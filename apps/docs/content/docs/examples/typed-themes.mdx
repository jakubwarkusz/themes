...
Use `createThemes` when your app has one canonical theme list. The tuple becomes the source of truth for the provider, hooks, `useThemeValue`, and `ThemedImage`.
